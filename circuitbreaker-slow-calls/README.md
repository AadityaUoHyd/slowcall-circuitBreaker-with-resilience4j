# circuitBreaker-slowCall-with-Resilience4j
microservices-circuitBreaker-slowCall-with-Resilience4j-using-JMeter

# Resilience4j Preventing cascading of slowness in REST API using Circuit Breaker 
We are going to learn how to prevent cascading of slowness from one service to other service using 
